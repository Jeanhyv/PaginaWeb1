...
$sql = "SELECT * FROM productos WHERE IdProducto BETWEEN 21 AND 30 LIMIT $inicio, $productos_por_pagina";
...
<head>
    <meta charset="UTF-8">
    <title>Frutas y Verduras - Tienda "La Rosa"</title>
    <style>
        /* Aquí va tu CSS */
        * {
            margin: 0;
...
<div class="container">
    <aside>
        ...
        <ul>
            ...
            <li><a href="http://localhost/Hola/conexion2.php">Carnes y Pescados</a></li>
